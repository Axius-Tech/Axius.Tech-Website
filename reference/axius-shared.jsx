...
window.AxiusCommitments = [
  ...
  },
  {
    ...
    body: 'Operator replaces a specialized contractor. Team replaces multiple operational hires. Department replaces an internal tech division.',
    bodyEs: 'Operador reemplaza un contratista especializado. Equipo reemplaza múltiples contrataciones operativas. Departamento reemplaza una división tech interna.',
    metric: { label: 'starts at', labelEs: 'desde', value: '$1,000 / mo', valueEs: '$1,000 / mes' },
  },
  {
    n: '04',
    title: 'Structured by default.',
    titleEs: 'Estructurado por defecto.',
    body: 'Every workflow, system, and configuration is documented inside your stack. Nothing lives in our accounts. Nothing disappears when someone leaves.',
    bodyEs: 'Cada workflow, sistema y configuración queda documentado dentro de tu stack. Nada vive en nuestras cuentas. Nada desaparece cuando alguien se va.',
    metric: { label: 'documentation', labelEs: 'documentación', value: 'owned by you', valueEs: 'tuya, siempre' },
  },
  {
    n: '05',
    title: 'One accountable layer.',
    titleEs: 'Una capa responsable.',
    body: 'One operator overseeing the systems, workflows, specialists, and execution behind the work. One line of communication. One operational system.',
    bodyEs: 'Un operador supervisando los sistemas, workflows, especialistas y ejecución detrás del trabajo. Una sola línea de comunicación. Un solo sistema operativo.',
    metric: { label: 'coordination', labelEs: 'coordinación', value: 'simplified', valueEs: 'simplificada' },
  },
];
...
window.AxiusPricing = [
  ...
  },
  {
    ...
    subEs: 'Para empresas que corren múltiples sistemas y necesitan coordinación, continuidad y optimización constante.',
    response: '48h',
...
window.AxiusFAQ = [
  ...
  { q: 'What if we\'re building a product, not running one?',
    qEs: '¿Y si estamos construyendo un producto, no operándolo?',
    a: 'Founder Track inside Team or Department, same retention structure. Builder ships an MVP in 3–4 months. Partner ships a substantial product in 4–6 months.',
    aEs: 'Founder Track dentro de Equipo o Departamento, misma estructura de retención. Builder entrega un MVP en 3–4 meses. Partner entrega un producto sustancial en 4–6 meses.' },
  { q: 'Where are you based?',
    qEs: '¿Dónde están basados?',
    a: 'Medellín, Colombia. Remote-first. Available on US business hours.',
    aEs: 'Medellín, Colombia. Remote-first. Disponibles en horario laboral de EE.UU.' },
];
...
window.AxiusFounder = {
  ...
  bioEs: "Hola, soy Andrés.\n\nDespués de años trabajando dentro de operaciones de PyMEs, seguí viendo el mismo problema: sistemas fragmentados, contratistas dispersos, y fundadores atrapados gestionando la complejidad operativa ellos mismos.\n\nAxius se construyó para resolver eso.\n\nSupervisamos el lado operativo del tech de tu negocio a través de una sola capa responsable, combinando sistemas estructurados, ejecución asistida por IA, y apoyo de especialistas cuando se necesita.\n\nEl objetivo es simple: tu negocio sigue moviéndose sin que tú operes la tech.",
