// ============================================================
// AXIUS · DIRECTION E — QUIET (MINIMAL · FUTURISTIC · LATENT COLOR)
// Warm-paper canvas, near-monochrome by default. Color is latent
// in the design — it only reveals on hover, focus, scroll entry,
// or other moments of curiosity. The page feels tranquil at first
// glance and rewards attention with small bursts of warmth.
// ============================================================

window.AxiusDirectionE = function () {
  ...
  React.useEffect(() => {
    ...
    if (!document.getElementById('axius-quiet-styles')) {
      const style = document.createElement('style');
      style.id = 'axius-quiet-styles';
      style.textContent = `
        @keyframes axQuietBreathe {
          0%, 100% { transform: scale(1); opacity: 0.55; }
          50%      { transform: scale(1.12); opacity: 0.85; }
        }
        @keyframes axQuietPulse {
          0%, 100% { box-shadow: 0 0 0 0 rgba(79,186,168,0.55); }
          50%      { box-shadow: 0 0 0 6px rgba(79,186,168,0); }
        }
        @keyframes axQuietGlow {
          0%, 100% { opacity: 0.45; transform: translate(-50%, -50%) scale(1); }
          50%      { opacity: 0.65; transform: translate(-50%, -50%) scale(1.06); }
        }
        .ax-quiet-scroll { scrollbar-width: thin; scrollbar-color: rgba(255,91,42,0.4) transparent; }
        .ax-quiet-scroll::-webkit-scrollbar { width: 8px; }
        .ax-quiet-scroll::-webkit-scrollbar-track { background: transparent; }
        .ax-quiet-scroll::-webkit-scrollbar-thumb {
          background: rgba(255,91,42,0.35);
          border-radius: 0;
        }
        .ax-quiet-scroll::-webkit-scrollbar-thumb:hover {
    ...
    return (
      <div style={{
        ...
        <span style={{
          ...
          background: C.mint,
          animation: 'axQuietPulse 2.4s ease-out infinite',
        }}/>
        <span style={{
  ...
  const QuietBtn = ({ children, primary, accent = C.tangerine, size = 'md', onClick, style = {} }) => {
    ...
    const ink = primary ? '#FFFFFF' : (h ? accent : C.ink);
    return (
      <button
        onClick={onClick}
        onMouseEnter={() => setH(true)}
    ...
    return (
      <header ref={heroRef} data-screen-label="00 Hero" style={{
        ...
        <div aria-hidden style={{
          ...
          animation: 'axQuietGlow 9s ease-in-out infinite',
        ...
        {(() => {
          ...
          return (
            <div style={{
              ...
              <div className="ax-quiet-scroll" style={{
    ...
    const thumbs = [
      {
        ...
        crop: '50% 20%',
        filterIdle: 'grayscale(0.85) sepia(0.18) contrast(1.05)',
        filterHover: 'grayscale(0) saturate(1.05) contrast(1.02)',
      },
      {
        fig: 'Fig. 03',
        caption: 'At the desk · documented',
        crop: '60% 38%',
        filterIdle: 'grayscale(0.9) contrast(1.08) brightness(0.96)',
        filterHover: 'grayscale(0) saturate(1.04) contrast(1.04)',
      },
      {
        fig: 'Fig. 04',
        caption: 'On duty · US business hours',
        crop: '40% 35%',
        filterIdle: 'grayscale(0.92) sepia(0.10) contrast(1.04)',
        filterHover: 'grayscale(0) saturate(1.06) contrast(1.02)',
      },
    ];
        ...
        <div style={{
          ...
          <div
            ...
            <img src={window.AxiusFounder.photo} alt="Andrés Toro" style={{
              ...
              filter: heroH ? 'grayscale(0) saturate(1.05) contrast(1.02)' : 'grayscale(1) contrast(1.02)',
  ...
  const CTA = () => (
    <section data-screen-label="10 CTA" style={{
      ...
      <div aria-hidden style={{
        ...
        animation: 'axQuietGlow 11s ease-in-out infinite',
        pointerEvents: 'none',
      }}/>
